...
public class Example2 {
    public static void main(String[] args) {
        ...
        if(py<60) System.out.println("탕탕탕");
        ...
        switch(기준식 또는 변수) {
            case 값1:
                기준식 또는 변수의 결과 값이 값1과 일치할 경우 실행할 문장;
                break;
            ....
            case 값n:
         ...
         주의사항-기준식 또는 변수의 결과값의 case의 값과 경우의 수가 같아야 하며, 경우의 수가
         같지 않는 경우 반드시 default 를 설정해야하며 case의 종료는 break로 해야 하며,
