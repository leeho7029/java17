...
public class ArraysEx1 {
    public static void main(String[] args) {
        ...
        System.out.println(arr1==arr3);//배열은 주소로 비교하게 된다
        System.out.println(Arrays.equals(arr1,arr3)); //배열의 값을 비교하려면 Arrays.equals를 쓴다
        ...
        System.out.println("80은 어디에? "+Arrays.binarySearch(points, 80));//2진검색
    }
}
