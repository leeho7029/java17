...
public class ApiEx1 {
    public static void main(String[] args) {
        /*
        java.lang 패키지 : 별도의 import 과정이 필요없는 기본클래스
        ...
        -Wrapper : Primitive타입을 클래스 타입으로 바꾸기위함.
            Character, Byte, Short, Integer, Long, Float, Double, Boolean등으로 구성되어 있으며
            Primitive타입은 멤버를 가질 수 없으므로, reference 타입인 해당 Wrapper를 활용하여 메서드를 활용할 수 있다.

         */
        int a = 1004; //primitive 타입
        Integer b = 1004; // Wrapper Type

        int a1 = b; //UnBoxing : b는 wrapper 타입이었지만 primitive 타입으로 바꾸는것
        Integer b1 = a; // Boxing : Primitive를 Wrapper로 바꿈
